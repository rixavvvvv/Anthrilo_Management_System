...
import { mrnApi, supplierApi, purchaseOrderApi, gateEntryApi } from '@/features/procurement';
import type { MRN, Supplier, PurchaseOrder, GateEntry } from '@/features/procurement';
